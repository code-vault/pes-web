          ...
          <div className="space-y-10">
            <div className="space-y-6">
              <div className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-orange-200/50 shadow-lg">
                ...
                <span className="text-sm font-medium text-gray-700">#1 Solar Installation Company</span>
              </div>
              
              <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight tracking-tight">
                Power Your Future with 
                <span className="bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 bg-clip-text text-transparent"> Solar Energy</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 leading-relaxed font-light">
                Transform your home or business with clean, renewable solar energy. Save money, 
                reduce your carbon footprint, and gain energy independence with our premium solar solutions.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="font-bold text-2xl text-gray-900">Save 70%+</p>
                <p className="text-sm text-gray-600 font-medium">On Energy Bills</p>
              </div>
              <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                <div className="bg-gradient-to-br from-blue-400 to-cyan-500 p-3 rounded-xl w-fit mb-4">
                  <Shield className="h-6 w-6 text-white" />
                </div>
                <p className="font-bold text-2xl text-gray-900">25-Year</p>
              ...
              <div className="bg-white/60 backdrop-blur-sm p-6 rounded-2xl border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="font-bold text-2xl text-gray-900">Clean</p>
                <p className="text-sm text-gray-600 font-medium">Energy Source</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/30 hover:shadow-3xl transition-all duration-500">
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-bold text-gray-900">Solar Savings Calculator</h3>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50/80 backdrop-blur-sm p-4 rounded-xl border border-gray-200/50">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 font-medium">Current Monthly Bill:</span>
                ...
                <div className="pt-4">
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-xl border border-blue-200/50">
                    <p className="text-sm text-gray-600 text-center">
                      <span className="font-semibold text-gray-900">25-year savings:</span> $40,500
                    </p>
                  </div>
                </div>
              </div>
